...
class StatusVectorChunk {
    ...
    static deSerialize(data) {
        ...
        switch (symbolSize) {
            case 0:
                range(6, (i) => symbolList.push((0, src_1.getBit)(data[0], 2 + i, 1)));
                range(8, (i) => symbolList.push((0, src_1.getBit)(data[1], i, 1)));
                break;
            case 1:
                range(3, (i) => symbolList.push((0, src_1.getBit)(data[0], 2 + i * 2, 2)));
                range(4, (i) => symbolList.push((0, src_1.getBit)(data[1], i * 2, 2)));
                break;
            default:
